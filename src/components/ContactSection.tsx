...
function ContactTabs() {
  return (
    <div className="flex gap-[39px] items-center leading-[normal] not-italic text-[40px] text-nowrap whitespace-pre mb-12">
      ...
      <p className="[text-underline-position:from-font] decoration-solid text-black underline">Schedule a Call</p>
    </div>
  );
}
    ...
    <div ref={contactRef} className="w-full max-w-[441px]">
      <form onSubmit={handleSubmit} className="w-full flex flex-col gap-[23px]">
        <div className="content-stretch flex flex-col gap-[8px] items-start w-full">
          <p className="capitalize leading-[normal] not-italic text-[16px] text-black text-nowrap whitespace-pre">name</p>
          <input
            type="text"
            value={formData.name}
        ...
        <div className="content-stretch flex flex-col gap-[8px] items-start w-full">
          <p className="leading-[normal] not-italic text-[16px] text-black text-nowrap whitespace-pre">Email</p>
          <input
            type="email"
        ...
        <div className="content-stretch flex flex-col gap-[8px] items-start w-full">
          <p className="capitalize leading-[normal] not-italic text-[16px] text-black text-nowrap whitespace-pre">message</p>
          <textarea
        ...
        <button
          type="submit"
          className="bg-[#c02071] box-border content-stretch flex gap-[24px] items-center justify-center overflow-clip px-[53px] py-[12px] rounded-[4px] hover:bg-[#d02881] transition-colors cursor-pointer"
        >
          <p className="leading-[normal] not-italic text-[20px] text-nowrap text-white whitespace-pre">Send</p>
        </button>
      </form>
    </div>
  );
